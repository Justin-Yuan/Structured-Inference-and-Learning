...
if __name__ == "__main__":
    ...
    attention_model = WordAttentionClassifier(batch_size=128, epochs=30, raw_data_path=None, embedded_data_path='../data/data_and_embedding100.npz', embedding_dim=100)
    if attention_model.model == None:
    ...
    print("Word Attention model saved")
