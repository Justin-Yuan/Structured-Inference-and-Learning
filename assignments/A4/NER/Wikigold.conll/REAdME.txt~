...
NER_on_Wikigold.conll.py (python script): refactored from the notebook, has structured utility functions, the main section also constructs, trains and evaluates a POS tagging model.
...
2. execute NER_on_Wikigold.conll.py to build and evaluate a POS tagging model 
